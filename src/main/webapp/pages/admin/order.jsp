        ...
        <div class="col-9">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="admin/order/<%= order.get("id") %>" class="btn btn-success btn-sm">View</a>
                        <a href="admin/order/edit/<%= order.get("id") %>" class="btn btn-primary btn-sm">Edit</a>
                        <a href="admin/order/delete/<%= order.get("id") %>" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                </tr>
                <% } %>
                </tbody>
